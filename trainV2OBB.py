...
data_yaml_path = "ContainerID.v4i.yolov8-obb/data.yaml"
checkpoint_path = "container_id_training/yolov8_container_detectionOBB/weights/last.pt"
...
training_config = {
    ...
    'name': 'yolov8_container_detectionOBB',
    'exist_ok': True
}
